    ...
    return (() => {
        var e = {
            725: (e, t, r) => {
                ...
                "use strict";
                r.r(t), r.d(t, {defaultOptions: () => o, fetchFile: () => m, getCreateFFmpegCore: () => u});
                var n = r(306);
                const o = {corePath: "./ffmpeg-core.js"};
                var a = r(185), i = r(835);
                    ...
                    var e = s(regeneratorRuntime.mark((function e(t, r) {
                        ...
                        return regeneratorRuntime.wrap((function (e) {
                            for (; ;) switch (e.prev = e.next) {
                                ...
                                case 5:
                                    return n = e.sent, (0, a.log)("info", "".concat(t, " file size = ").concat(n.byteLength, " bytes")), o = new Blob([n], {type: r}), i = URL.createObjectURL(o), (0, a.log)("info", "".concat(t, " blob URL = ").concat(i)), e.abrupt("return", i);
                                case 11:
                                case"end":
                                    return e.stop()
                            }
                        ...
                        return regeneratorRuntime.wrap((function (e) {
                            for (; ;) switch (e.prev = e.next) {
                                ...
                                case 18:
                                    ...
                                    throw Error("corePath should be a string!");
                                case 20:
                                    return p = new URL(r, location.href).href, e.next = 23, f(p, "application/javascript");
                                case 23:
                ...
                e.exports = {
                    defaultArgs: ["./ffmpeg", "-nostdin", "-y"], baseOptions: {
                ...
                var m = r(500), h = m.defaultArgs, g = m.baseOptions, d = r(319), y = r(839), v = y.defaultOptions,
                    w = y.getCreateFFmpegCore, b = r(306).version,
                    x = Error("ffmpeg.wasm is not ready, make sure you have completed load().");
                e.exports = function () {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                        t = u(u(u({}, g), v), e), r = t.log, o = (t.logger, t.progress),
                        c = p(t, ["log", "logger", "progress"]), s = null, f = null, l = null, m = null, y = !1,
                        F = function () {
                        }, j = r, E = o, P = 0, O = 0, k = !1, L = 0, S = function (e) {
                            "FFMPEG_END" === e && null !== l && (l(), l = null, m = null, y = !1)
                        }, _ = function (e, t) {
                            F({type: e, message: t}), j && console.log("[".concat(e, "] ").concat(t))
                        }, C = function (e) {
                            ...
                            if ("string" == typeof e) if (e.startsWith("  Duration")) {
                                var r = e.split(", ")[0].split(": ")[1], n = C(r);
                                t({duration: n, ratio: L}), (0 === P || P > n) && (P = n, k = !0)
                                ...
                                var i = e.split("time=")[1].split(" ")[0], c = C(i), s = e.match(/frame=\s*(\d+)/);
                                if (O && s) {
                ...
                var t = function (e) {
                    ...
                    function f(e, t, r, n) {
                        var o = t && t.prototype instanceof d ? t : d, a = Object.create(o.prototype),
                            i = new L(n || []);
                    ...
                    e.wrap = f;
                    var l = "suspendedStart", p = "suspendedYield", m = "executing", h = "completed", g = {};
